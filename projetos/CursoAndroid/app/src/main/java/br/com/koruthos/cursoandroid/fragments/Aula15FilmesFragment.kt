...
import br.com.koruthos.cursoandroid.databinding.FragmentAula15FilmesBinding
import br.com.koruthos.cursoandroid.databinding.FragmentAula15HomeBinding
 ...
 *
 */
class Aula15FilmesFragment : Fragment() {

    private lateinit var mBinding: FragmentAula15FilmesBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        mBinding = FragmentAula15FilmesBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mBinding.aula15TxtDisplay.text = activity?.getText(R.string.aula15_txt_filmes)
    }
     ...
     */
    companion object {
        fun newInstance() = Aula15FilmesFragment()
    }
