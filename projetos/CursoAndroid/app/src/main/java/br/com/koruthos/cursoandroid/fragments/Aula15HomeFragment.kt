 ...
 *
 */
class Aula15HomeFragment : Fragment() {

    private lateinit var mBinding: FragmentAula15HomeBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        mBinding = FragmentAula15HomeBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mBinding.aula15TxtHome.text = activity?.getText(R.string.aula15_txt_home)
    }
    ...
    companion object {
        ...
        fun newInstance() = Aula15HomeFragment()
    }
