...
import br.com.koruthos.cursoandroid.databinding.FragmentAula15PerfilBinding
 ...
 *
 */
class Aula15PerfilFragment : Fragment() {

    private lateinit var mBinding: FragmentAula15PerfilBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        mBinding = FragmentAula15PerfilBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mBinding.aula15TxtDisplay.text = activity?.getText(R.string.aula15_txt_perfil)
    }
     ...
     */
    companion object {
        fun newInstance() = Aula15PerfilFragment()
    }
}
