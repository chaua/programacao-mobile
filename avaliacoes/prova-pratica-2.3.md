...
Desenvolver e apresentar uma aplicação mobile funcional, a ser implementada em equipe, de forma a integrar os conteúdos teóricos e práticos abordados ao longo da disciplina. A atividade visa consolidar os conhecimentos sobre arquitetura de aplicações móveis, design de interfaces, integração com APIs e serviços, gerenciamento de dados locais e em nuvem, utilizando o framework Flutter ou plataformas nativas (Android/iOS).Cada equipe deverá:
...
## 💡 Ideias de aplicativos <a href="#ideias-de-aplicativos" id="ideias-de-aplicativos"></a>
...
## ⚙️ Requisitos técnicos <a href="#requisitos-tecnicos" id="requisitos-tecnicos"></a>
...
* Deve utilizar obrigatoriamente **uma** das combinações abaixo:
...
### **🏆 Critérios de Avaliação** <a href="#criterios-de-avaliacao" id="criterios-de-avaliacao"></a>
